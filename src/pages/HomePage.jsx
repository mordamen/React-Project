            ...
            */
				...
				setCardsArr(
					newOriginalCardsArr.filter(
						(card) => card.title.startsWith(filter) || card.bizNumber.startsWith(filter)
					)
				);
			}
		};
			...
			<Container maxWidth='false' className='hero-section' sx={{ display: 'flex' }}>
				<Container sx={{ maxWidth: 'sm', display: 'flex', flexDirection: 'column', m: 'auto' }}>
					...
					<Typography
						...
						gutterBottom
					>
						Whether you're looking for a new partner, client, or supplier, our website is the ultimate
						resource for finding and connecting with top businesses. So why wait? Start browsing today and
